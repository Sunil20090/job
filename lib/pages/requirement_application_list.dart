...
import 'package:job/components/counter.dart';
...
class _RequirementApplicationListState
  ...
  Widget build(BuildContext context) {
    return ScreenFrame(
      titleBar: ScreenActionBar(title: 'Applicatons', backButtonEnabled: true),
      body: (!_fetchingUsers)
          ? Container(
              child: Column(
                    ...
                    return ListTile(
                      ...
                      title: Column(
                        ...
                        children: [
                          ...
                          addVerticalSpace(),
                          Text('${user['remark']}', softWrap: true),
                        ],
                      ),
                    );
                  }).toList(),
  ...
  void _initAppliedUserList() async {
    ...
    ApiResponse response = await postService(
      URL_APPLED_USERS_FOR_REQUIREMENT,
      body,
    );
