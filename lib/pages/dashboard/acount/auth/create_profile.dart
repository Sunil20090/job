...
import 'package:job/pages/dashboard/acount/auth/otp_verification.dart';
...
class _CreateProfileState extends State<CreateProfile> {
  ...
  Widget build(BuildContext context) {
    return ScreenFrame(
      titleBar: ScreenActionBar(title: 'Create Profile'),
      body: Column(
        children: [
          addVerticalSpace(),
          Column(
                  ...
                  ? ColoredButton(
                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          Icon(Icons.check, color: COLOR_BASE),
                        ],
                      ),
                    )
                  : ColoredButton(
  ...
  openOTPScreen() {
    Navigator.pushReplacement(
      context,
      MaterialPageRoute(builder: (builder) => OtpVerification()),
    );
  }
}
