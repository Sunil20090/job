...
import 'package:job/pages/dashboard/acount/auth/create_profile.dart';
import 'package:job/pages/dashboard/acount/auth/edit_profile_screen.dart';
import 'package:job/pages/dashboard/acount/auth/login_page.dart';
import 'package:job/pages/dashboard/problem/add_requirement_screen.dart';
import 'package:job/pages/dashboard/problem/edit_problem_screen.dart';
...
class _AccountScreenState extends State<AccountScreen>
                ...
                children: [
                        ...
                        children: [
                          ...
                          Row(
                            ...
                            children: [
                              ...
                              Icon(Icons.error_outline, color: COLOR_PRIMARY),
                              Text(
                                formatNumber(
                                  _accountDetails['problem_posted_count'],
                                ),
                                style: getTextTheme(
                                  color: COLOR_BLACK,
                                ).titleSmall,
                              ...
                              addHorizontalSpace(16),
                              Icon(Icons.account_tree, color: COLOR_PRIMARY),
                              Text(
                                formatNumber(_accountDetails['tracking_count']),
                                style: getTextTheme(
                                  color: COLOR_BLACK,
                                ).titleSmall,
                              ),
                  ...
                  Container(
                    ...
                    child: Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        Text('Description:', style: getTextTheme().titleSmall),
                        Container(
                          child: Text(
                        ...
                        Row(
                          children: [
                            Text('Skills:', style: getTextTheme().titleSmall),
                            if (_fetchingSkill)
                        ...
                        Divider(),
                        Text('Problems:', style: getTextTheme().titleSmall),
                        addVerticalSpace(4),
                        Column(
              ...
              child: Column(
                ...
                children: [
                  Row(
                    mainAxisAlignment: MainAxisAlignment.center,
                    children: [
                      Text('No Profile', style: getTextTheme().headlineMedium),
                    ],
                  ),
                  addVerticalSpace(),
                  Icon(Icons.no_accounts, size: 54, color: COLOR_PRIMARY),
                  addVerticalSpace(),
                  Row(
                    mainAxisAlignment: MainAxisAlignment.center,
                    children: [
  ...
  void moveToAccountForm() {
    Navigator.push(
      context,
      MaterialPageRoute(builder: (builder) => CreateProfile()),
    );
  }
