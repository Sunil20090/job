...
import 'package:job/components/comment_item.dart';
import 'package:job/components/enter_text_box.dart';
import 'package:job/components/progress_circular.dart';
import 'package:job/components/screen_frame.dart';
import 'package:job/components/scrollable_page_view.dart';
...
class ProblemDetailScreen extends StatefulWidget {
  ...
  ProblemDetailScreen({super.key, this.problem});
...
class _ProblemDetailScreenState extends State<ProblemDetailScreen> {
      ...
      body: Column(
        ...
        children: [
          Container(
            ...
            child: Stack(
              children: [
                ScrollablePageView(images: _images),
                Positioned(
                  bottom: 0,
                  left: 0,
                  right: 0,
                        ...
                        Column(
                          ...
                          children: [
                            ...
                            Text(
                              ...
                              style: getTextTheme(color: COLOR_WHITE).bodySmall,
                            ),
                          ],
                        ),
                        Spacer(),
  ...
  void initCommentList(id) {
    postService(URL_GET_COMMENT_LIST, {
      "problem_id": id,
      "user_id": USER_ID,
    }).then((response) {
      if (response.isSuccess) {
