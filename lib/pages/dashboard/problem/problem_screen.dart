import 'package:job/components/image_with_title.dart';
...
import 'package:job/pages/common_pages/notification/notification_screen.dart';
import 'package:job/pages/dashboard/problem/post_problem_screen.dart';
import 'package:job/pages/dashboard/problem/problem_detail_screen.dart';
import 'package:job/pages/dashboard/acount/other_account_screen.dart';
import 'package:job/pages/search_screen.dart';
...
class _ProblemScreenState extends State<ProblemScreen> {
  ...
  getNotificationCount() async {
    ApiResponse response = await postService(URL_NOTIFICATION_COUNT, {
      "user_id": USER_ID,
    });
            ...
            children: [
              if (_result == null)
                ...
                Padding(
                  ...
                  child: Row(
                    children: [
                      Text(_result!, style: getTextTheme().titleSmall),
                      addHorizontalSpace(),
                      InkWell(
                        onTap: () {
                          setState(() {
                    ...
                    return Column(
                      children: [
                        ImageWithTitle(
                                  ...
                                  child: Row(
                                    ...
                                    children: [
                                      Icon(
                                        ...
                                        color: COLOR_RED,
                                        size:
                                            getTextTheme().titleSmall?.fontSize,
                                      ),
                          ...
                          avatarThumbnailUrl:
                              _problemList[index]['user_thumbnail_url'],
              ...
              if (_fetchingList)
                Container(
                  ...
                  child: Row(
                    ...
                    children: [ProgressCircular(color: COLOR_BLACK)],
                  ),
                ),
            ],
          ),
  ...
  showProfile(int id) {
    Navigator.push(
      context,
      MaterialPageRoute(
        builder: (builder) => OtherAccountScreen(profile_id: id),
      ),
    );
  }
