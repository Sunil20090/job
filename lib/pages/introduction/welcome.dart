import 'package:job/pages/card_list.dart';
...
class OnBoardingPage extends StatelessWidget {
  void _onIntroEnd(context) {
    Navigator.of(
      context,
    ).pushReplacement(MaterialPageRoute(builder: (_) => CardListScreen()));
  }
    ...
    return IntroductionScreen(
      pages: [
        ...
        PageViewModel(
          ...
          image: const Center(
            child: Icon(Icons.rocket_launch, size: 100, color: Colors.purple),
          ),
        ),
      ],
