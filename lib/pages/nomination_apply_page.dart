...
import 'package:job/components/page_heading.dart';
import 'package:job/constants/local_constant.dart';
      ...
      body: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            addVerticalSpace(40),
            Text("Nominate for: ", style: getTextTheme().headlineSmall),
            SizedBox(
              height: 160,
              child: ListView(
                children: positions
                    .map(
                      (toElement) => RadioListTile(
